...
I was working on something where we needed to modify a file using PowerShell and check in the changes back to TFS. Checking out the fine was causing some troubles. Let's look at the details. 
